...
{  ?>
        <div class="product-listing-m gray-bg">
          ...
          <div class="product-listing-content">
            <h5><a href="room-details.php?vhid=<?php echo htmlentities($result['id']);?>"><?php echo htmlentities($result['BrandName']);?> , <?php echo htmlentities($result['VehiclesTitle']);?></a></h5>
...
<option value="CNG">CNG</option>
    ...
    <?php $sql = "SELECT DISTINCT bed.*,room.Room as bid, bedding.Status as status from bed 
...
?>
        ...
        <div class="sidebar_widget">
          <div class="widget_heading">
            <h5><i class="fa fa-car" aria-hidden="true"><h3 style = "color:red"><?php echo htmlentities($re['count']);?></h3></i> Recently Listed Cars</h5>
          </div>
