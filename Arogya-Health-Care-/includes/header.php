    ...
    <div class="container">
      <div class="row">
        <div class="col-sm-3 col-md-2">
          <div class="logo"> <a href="index.php"><img src ="blue/s2.jpg" alt="image"/></a> </div>
        </div>
        <div class="col-sm-9 col-md-10">
          <div class="header_info">
            <div class="header_widgets">
              <p class="uppercase_text">E-Mail us : </p>
              <a href="mailto:'" >Adebayo Medinah G.</a> </div>
            <div class="header_widgets">
              
              <p class="uppercase_text">Call Us: </p>
              <a href="tel:61-1234-5678-09">+2348130584550</a> </div>
	 ...
	 echo htmlentities($result['Full_Name']); //}?><i class="fa fa-angle-down" aria-hidden="true"></i></a>
           ...
           <?php if($_SESSION['login']){?>
            <li><a href="profile.php" style="color: red;">Profile Settings</a></li>
              <li><a href="update-password.php" style="color: red;">Update Password</a></li>
            ...
            <li><a href="#loginform"  data-toggle="modal" data-dismiss="modal" style="color: red;">Profile Settings</a></li>
              <li><a href="#loginform"  data-toggle="modal" data-dismiss="modal" style="color: red;">Update Password</a></li>
      ...
      <div class="collapse navbar-collapse" id="navigation">
        <ul class="nav navbar-nav">
          ...
          <li><a href="contact-us.php" style="color: red;">Contact us</a></li>
