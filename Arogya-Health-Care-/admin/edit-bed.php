...
PowerDoorLocks='$powerdoorlocks',AntiLockBrakingSystem='$antilockbrakingsys',BrakeAssist='$brakeassist'
 where id='$id' ";
...
$t = mysqli_query($conn, $ret);
$cnt=1;

  while($results = mysqli_fetch_array($t))
{  
